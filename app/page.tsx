  ...
  return (
    <main style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #080e18 0%, #0a0a0a 100%)' }}>
      <div style={{ textAlign: 'center', padding: '0 24px' }}>
        ...
        <h1 style={{ fontSize: 36, fontWeight: 700, color: '#ffffff', marginBottom: 8 }}>CardLab</h1>
        <p style={{ fontSize: 14, color: '#64748b', marginBottom: 4 }}>디지털 명함 플랫폼</p>
        <p style={{ fontSize: 12, color: '#374151' }}>Professional Digital Business Card</p>
      </div>
      <div style={{ position: 'fixed', bottom: 24, right: 24 }}>
        <Link href="/admin/login" style={{ fontSize: 12, color: '#1e3a5f', textDecoration: 'none' }}>···</Link>
      </div>
    </main>
  )
}
