  ...
  return (
    <main style={{ minHeight:'100dvh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'linear-gradient(135deg,#080e18 0%,#0a0a0a 100%)' }}>
      <div style={{ textAlign:'center', padding:'0 24px' }}>
        <div style={{ width:64, height:64, borderRadius:16, background:'linear-gradient(135deg,#1e3a5f,#1e40af)', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 24px', boxShadow:'0 12px 32px rgba(30,64,175,0.4)' }}>
      ...
      <div style={{ position:'fixed', bottom:24, right:24 }}>
        <Link href="/admin/login" style={{ fontSize:12, color:'#1e2d42', textDecoration:'none' }}>···</Link>
      </div>
    </main>
  )
}
